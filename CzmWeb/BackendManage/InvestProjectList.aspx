<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvestProjectList.aspx.cs" Inherits="CzmWeb.BackendManage.InvestProjectList" %>
    ...
    <div>
        ...
        <div >
            <center style="font-family:楷体,华文楷体,微软雅黑">
                投资用户ID<asp:TextBox ID="txtUserId" runat="server"  Width="150px" Height="22px" ></asp:TextBox>
                ...
                <asp:Repeater ID="rpItem" runat="server" OnItemCommand="rpItem_ItemCommand">
                    ...
                    <ItemTemplate>
                        <tr class='A_p_item_<%# Container.ItemIndex % 2 %>' >
                            <td align="center">
                                <asp:Button ID="btndelete" runat="server" Text="" CssClass="btnDelete" OnClientClick="javascript:return confirm('你确定要删除吗');"  CommandArgument='<%#Eval("PiiID")%>' CommandName="Delete"/>
                            </td>
                            <td align="center">
                                <%#Eval("PiiID")%>
                            </td>
                            <td align="center">
                                <%#Eval("InsertProjectName")%>
                            </td>
                            <td align="center">
                                <%#Eval("UserId")%>
                            </td>
                            ...
                            <td align="center" width="200px">
                                <asp:Button ID="Button5" runat="server" Text="通过" CssClass="Save" Visible='<%#Eval("PiiState").ToString()=="10" %>'  CommandArgument='<%#Eval("PiiID")%>' CommandName="OK" />
                                <asp:Button ID="Button1" runat="server" Text="不通过" CssClass="Save" Visible='<%#Eval("PiiState").ToString()=="10" %>' CommandArgument='<%#Eval("PiiID")%>' CommandName="NotOK" />
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
