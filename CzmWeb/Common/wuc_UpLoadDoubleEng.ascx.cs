...
{
    public partial class wuc_UpLoadDoubleEng : System.Web.UI.UserControl
    {
        ...
        public String GetImgServerPath()
        {
            ...
            {
                return "Not yet upload any pictures";
            }
            else
            {
        ...
        public void UpFile()
        {
            ...
            try
            {
                if (FlUpLoad.HasFile)
                {
                    ...
                    if (isStanderded == "")
                    {
                        MessaegBox("File format is only support jpg gif png bmp jpeg ！");
                        return;
                    }
                    if (File.Exists(Server.MapPath(MapPaths) + Path.GetFileName(FlUpLoad.PostedFile.FileName)))
                    {
                        MessaegBox("File name has been repeated！");
                        return;
                    }
                ...
                {
                    MessaegBox("Please choose to upload the file！");
                    return;
                }
            }
            catch (Exception ex)
        ...
        public void UpFile2()
        {
            ...
            try
            {
                if (FlUpLoad2.HasFile)
                {
                    ...
                    if (isStanderded == "")
                    {
                        MessaegBox("File format is only supported jpg gif png bmp jpeg ！");
                        return;
                    }
