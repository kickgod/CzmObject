...
<style type="text/css">
    ...
    @media only screen and (min-width:0px ) and (max-width: 440px) {
        .thumbnail img{ width: 300px;height: 280px}
        .TypeIntroductions{ font-family: ProductFontStyle;font-size: 16px;padding-left: 20px;height: 320px;overflow: hidden;}
    }
</style>
            ...
            <ItemTemplate>
                <div class="col-sm-6 col-md-6">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h3 class="introShowWord introShowWordNew">[Product Category]<%#Eval("typeName_c")%></h3>
                            <p class="TypeIntroductions">
                                <strong>Introduction:</strong> <%#Eval("TypeDecription_c")%>
                            </p>
                        </div>
                    </div>
                </div>
