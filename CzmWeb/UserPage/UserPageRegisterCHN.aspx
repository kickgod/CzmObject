        ...
        <div class="Head" id="headerCaidan">
            ...
            <div class="NavPhone">
                <ul>
                    ...
                    <li><img class="PhoneImg" src="../Images/SystemPicture/NavPhoneLogin20171001.png"/><a href="UserPageRegisterCHN.aspx"><asp:Label ID="lblUserLogin" runat="server"  CssClass="FontColor" Text="用户注册"></asp:Label></a></li>
                </ul>
            </div>
            <div class="Login_ACE">
                <ul>
