...
<body>
    ...
    <div class="Div_Center">
        <div class="Div_Main">
            ...
            <div>
                 <span class="TFS_Standardstyle">使用文档下载：</span><asp:HyperLink ID="HyperLink1" CssClass="TFS_Standardstyle" NavigateUrl="../ForePage/使用文档.docx" runat="server">点击下载</asp:HyperLink>
            </div>
        </div>
