<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefalutEngs.aspx.cs" Inherits="CzmWeb.defalut" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .FirstTimeDivLogo i{opacity: 0.6;filter: opacity(60);letter-spacing:4px;  margin-left: 40px;margin-top: 5px; font-size: 40px;color: white;font-family: '微软雅黑';height: 58px;vertical-align: bottom}
    </style>
</head>
<body>
<div class="FirstTimeDivLogo">
    <a class="navbar-brand" href="#Adminsrator"><i>FISH TOOL</i></a>
</div>
<!--导航部分bootstrap框架-->
        ...
        <div id="myCarouse2" class="carousel slide"  data-interval=1500  >
            ...
            <div class="carousel-inner">
                <div class="carousel-inner">
                    ...
                    <asp:Repeater ID="reptmProjects" runat="server">
                        <ItemTemplate>
                            <div class="item">
