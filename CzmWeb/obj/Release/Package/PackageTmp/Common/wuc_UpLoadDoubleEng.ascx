<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wuc_UpLoadDoubleEng.ascx.cs" Inherits="CzmWeb.Common.wuc_UpLoadDoubleEng" %>
...
<asp:Button ID="Button1" runat="server" Text="Upload"   OnClick="Button1_Click" CssClass="btnTop" />
...
<asp:Button ID="Button2" runat="server" Text="Upload"   OnClick="Button2_Click" CssClass="btnTop" />
