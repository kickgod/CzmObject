<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserUpradeList.aspx.cs" Inherits="CzmWeb.BackendManage.UserUpradeList" %>
                ...
                <asp:Repeater ID="rpItem" runat="server" OnItemDataBound="rpItem_ItemDataBound" OnItemCommand="rpItem_ItemCommand">
                    ...
                    <ItemTemplate>
                        <tr class='p_item_<%# Container.ItemIndex % 2 %>' onmouseover="c=this.className;this.className='p_item_hover';"
                            ...
                            <td align="center">
                                <asp:Button ID="Button3" runat="server" Text="通过"  CssClass="Save"  Visible='<%# Eval("UserType").ToString()=="1"&&Eval("UserState").ToString()=="30" %>'  CommandArgument='<%#Eval("UserId")%>' CommandName="Up"/>
                                <asp:Button ID="Button4" runat="server" Text="不通过"  CssClass="Save"  Visible='<%# Eval("UserType").ToString()=="1"&&Eval("UserState").ToString()=="30" %>'  CommandArgument='<%#Eval("UserId")%>' CommandName="Down"/>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
