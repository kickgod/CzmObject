<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvestPlaceAdd.aspx.cs" Inherits="CzmWeb.BackendManage.InvestPlaceAdd" %>
<!DOCTYPE html>
                   ...
                   <tr>
                    ...
                    <tr>
                        <td colspan="4" align="center">
                            ...
                            <asp:Button ID="btnDelete" CssClass="Save" runat="server" Text="删除"  OnClientClick="return confirm('讲会删除此省市下的所以地区确定吗?')" OnClick="btnDelete_Click"/>
                        </td>
                    </tr>
               </table>
            </div>
